...
@section('page_name', 'الموظفين المحذوفين')
@section('main_page_name', 'الرئيسية')
@section('current_page_name', 'الموظفين المحذوفين')
...
@section('content')
    ...
    <section class="content">
        @livewire('back-end.emoloyees.soft-delete')
        @livewire('back-end.emoloyees.restore')
    </section>
    <!-- /.content -->
...
<script>
    ...
    {
        Livewire.on('emoloyeesRestoreMS', function()
        {
            toastr.success('تم تفعيل الموظفين المحذوفين بنجاح', 'رسالة تفعيل', { timeOut: 5000 });
        });

        Livewire.on('employeesValidationMS', function()
        {
         ...
         Livewire.on('emoloyeesErrorMS', function()
        {
