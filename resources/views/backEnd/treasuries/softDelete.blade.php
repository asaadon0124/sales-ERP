...
@section('title', 'الخزن المحذوفة')
@section('page_name', 'الخزن المحذوفة')
...
@section('content')
    ...
    <section class="content">
        @livewire('back-end.treasuries.soft-delete')
        @livewire('back-end.treasuries.restore')
...
<script>
    ...
    {
        Livewire.on('treasuriesRestoreMS', function()
        {
            toastr.success('تم تفعيل الخزنة بنجاح', 'رسالة تفعيل', { timeOut: 5000 });
        });
