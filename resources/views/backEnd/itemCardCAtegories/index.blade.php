...
@section('title', 'فئات حركات الصنف')
@section('page_name', 'فئات حركات الصنف')
@section('main_page_name', 'الرئيسية')
@section('current_page_name', 'فئات حركات الصنف ')
...
@section('content')
    ...
    <section class="content">
        @livewire('back-end.item-card-movement-category.data')
        @livewire('back-end.item-card-movement-category.create')
        @livewire('back-end.item-card-movement-category.update')
        @livewire('back-end.item-card-movement-category.delete')
...
<script>
    ...
    {
        Livewire.on('ItemCardMovementCategoryUpdateMS', function()
        {
            toastr.success('Update Successfully', 'Updated', { timeOut: 5000 });
        });


        Livewire.on('ItemCardMovementCategoryCreateMS', function()
        {
        ...
        // Livewire.on('ItemCardMovementCategoryShow', function(data)
        // {
