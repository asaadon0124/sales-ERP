...
@section('page_name', 'تقارير الموظفين')
@section('main_page_name', 'الرئيسية')
@section('current_page_name', 'تقارير الموظفين ')
@section('current_page_link', route('Reborts.employees.index'))
...
@section('content')
    ...
    <section class="content">
        @livewire('back-end.reborts.employees.data')
