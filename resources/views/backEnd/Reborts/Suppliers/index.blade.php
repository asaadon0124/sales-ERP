...
@section('page_name', 'تقارير الموردين')
@section('main_page_name', 'الرئيسية')
@section('current_page_name', 'تقارير الموردين ')
@section('current_page_link', route('Reborts.suppliers.index'))
...
@section('content')
    ...
    <section class="content">
        @livewire('back-end.reborts.suppliers.data')
