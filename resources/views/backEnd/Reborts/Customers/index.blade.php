...
@section('page_name', 'تقارير العملاء')
@section('main_page_name', 'الرئيسية')
@section('current_page_name', 'تقارير العملاء ')
@section('current_page_link', route('Reborts.customers.index'))
...
@section('content')
    ...
    <section class="content">
        @livewire('back-end.reborts.customers.data')
