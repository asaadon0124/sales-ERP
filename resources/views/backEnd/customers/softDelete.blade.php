...
@section('title', 'العملاء المحذوفة')
@section('page_name', 'العملاء المحذوفة')
@section('main_page_name', 'الرئيسية')
@section('current_page_name', 'العملاء المحذوفة')
@section('current_page_link', route('customers.index'))
...
@section('content')
    ...
    <section class="content">
        @livewire('back-end.customer.soft-delete')
        @livewire('back-end.customer.restore')
...
<script>
    ...
    {
        Livewire.on('customersRestoreMS', function()
        {
            toastr.success('تم تفعيل العملاء المحذوفة بنجاح', 'رسالة تفعيل', { timeOut: 5000 });
        });

        Livewire.on('customersValidationMS', function()
        {
         ...
         Livewire.on('customersErrorMS', function()
        {
