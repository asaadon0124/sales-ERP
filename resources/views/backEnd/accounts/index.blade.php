...
@section('page_name', 'الحسابات')
@section('main_page_name', 'الرئيسية')
@section('current_page_name', 'الحسابات ')
...
@section('content')
    ...
    <section class="content">
        @livewire('back-end.accounts.data')
        @livewire('back-end.accounts.create')
        @livewire('back-end.accounts.update')
        @livewire('back-end.accounts.Delete')
        @livewire('back-end.accounts.Show')
...
<script>
    ...
    {
        Livewire.on('accountsUpdateMS', function()
        {
            toastr.success('تم تحديث الحساب بنجاح', 'رسالة تعديل', { timeOut: 5000 });
        });



        Livewire.on('accountsCreateMS', function()
        {
        ...
        // Livewire.on('accountsShow', function(data)
        // {
