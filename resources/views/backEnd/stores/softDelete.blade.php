...
@section('title', 'المخازن المحذوفة')
@section('page_name', 'المخازن المحذوفة')
@section('main_page_name', 'الرئيسية')
@section('current_page_name', 'المخازن المحذوفة')
...
@section('content')
    ...
    <section class="content">
        @livewire('back-end.stores.soft-delete')
        @livewire('back-end.stores.restore')
...
<script>
    ...
    {
        Livewire.on('storesRestoreMS', function()
        {
            toastr.success('تم تفعيل المخازن المحذوفة بنجاح', 'رسالة تفعيل', { timeOut: 5000 });
        });

        Livewire.on('storeValidationMS', function()
        {
            toastr.success('هذا المخزن غير موجود', 'رسالة تحزير', { timeOut: 5000 });
        });
