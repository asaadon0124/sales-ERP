...
@section('page_name', 'المناديب')
@section('main_page_name', 'الرئيسية')
@section('current_page_name', 'المناديب ')
...
@section('content')
    ...
    <section class="content">
        @livewire('back-end.servant.data')
        @livewire('back-end.servant.create')
        @livewire('back-end.servant.update')
        @livewire('back-end.servant.delete')
