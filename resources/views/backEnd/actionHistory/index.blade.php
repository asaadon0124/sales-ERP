...
@section('title', 'ارشيف حركات النظام')
@section('page_name', 'ارشيف حركات النظام')
@section('main_page_name', 'الرئيسية')
@section('current_page_name', 'ارشيف حركات النظام ')
@section('current_page_link', route('actionHistory.index'))
...
@section('content')
    ...
    <section class="content">
        @livewire('back-end.action-history.data')
    </section>
    <!-- /.content -->
