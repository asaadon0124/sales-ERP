...
@section('page_name', 'حركات صرف النقدية')
@section('main_page_name', 'الرئيسية')
@section('current_page_name', 'حركات صرف النقدية')
...
@section('content')
    ...
    <section class="content">
        @livewire('back-end.treasury-transation.data-pay')
        @livewire('back-end.treasury-transation.delete-pay')
...
<script>
    document.addEventListener('DOMContentLoaded', function()
    {
        ...
        {
            toastr.success('تم تحديث الصرف بنجاح', 'رسالة تحديث', { timeOut: 5000 });
        });
        ...
        {
            // alert('dsd');
            toastr.success('تم اضافة الصرف بنجاح', 'رسالة اضافة', { timeOut: 5000 });
        ...
        {
            // alert('dsd');
            toastr.error('تم حذف الصرف بنجاح', 'رسالة حذف', { timeOut: 5000 });
            // Flasher['success']('Update Successfully');
        });
