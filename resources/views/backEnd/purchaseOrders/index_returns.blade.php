...
@section('title','فواتير مرتجع المشتريات ')

@section('page_name', 'فواتير مرتجع المشتريات  من الموردين')
@section('main_page_name', 'الرئيسية')
@section('current_page_name', 'فواتير مرتجع المشتريات  من الموردين')
...
@section('content')
    ...
    <section class="content">
        @livewire('back-end.purchase-order-returns.data')
        @livewire('back-end.purchase-order-returns.create')
        @livewire('back-end.purchase-order-returns.update')
        @livewire('back-end.purchase-order-returns.delete')
        @livewire('back-end.purchase-order-returns.aprove')
...
<script>
    ...
    {
        Livewire.on('purchaseOrdersUpdateMS', function()
        {
            toastr.success('تم تحديث الفاتورة بنجاح', 'رسالة تحديث', { timeOut: 5000 });
        });


        Livewire.on('purchaseOrdersCreateMS', function()
        {
            // alert('dsd');
        ...
        Livewire.on('purchaseOrdersDeleteMS', function()
        {
            // alert('dsd');
        ...
        Livewire.on('purchaseOrdersApproveMS', function()
        {
            // alert('dsd');
        ...
        Livewire.on('purchaseOrdersErrorMS', function()
        {
            toastr.error('هناك خطا ما برجاء المحاولة فيما بعد ', 'رسالة خطا', { timeOut: 5000 });
        });

        // Livewire.on('purchaseOrdersShow', function(data)
        // {
