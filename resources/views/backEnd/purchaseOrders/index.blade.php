...
@section('page_name', 'فواتير المشتريات من الموردين')
@section('main_page_name', 'الرئيسية')
@section('current_page_name', 'فواتير المشتريات من الموردين')
...
@section('content')
    ...
    <section class="content">
        @livewire('back-end.purchase-orders.data')
        @livewire('back-end.purchase-orders.create')
        @livewire('back-end.purchase-orders.update')
        @livewire('back-end.purchase-orders.delete')
        @livewire('back-end.purchase-orders.aprove')
