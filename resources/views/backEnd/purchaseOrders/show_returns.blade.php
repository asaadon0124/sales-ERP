...
@section('title', 'تفاصيل فاتورة مرتجع المشتريات')
@section('page_name', 'تفاصيل فاتورة مرتجع المشتريات')
@section('main_page_name', 'الرئيسية')
@section('current_page_name', 'تفاصيل فاتورة مرتجع المشتريات ')
...
@section('content')
    ...
    <section class="content">
        @livewire('back-end.purchase-order-returns.show', ['id' => $id])
        @livewire('back-end.purchase-order-detailes-returns.create')
        @livewire('back-end.purchase-order-detailes-returns.update')
        @livewire('back-end.purchase-order-detailes-returns.delete')
        @livewire('back-end.purchase-order-detailes-returns.show')
