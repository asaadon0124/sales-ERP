...
@section('title', 'الاصناف المحذوفة')
@section('page_name', 'الاصناف المحذوفة')
@section('main_page_name', 'الرئيسية')
@section('current_page_name', 'الاصناف المحذوفة')
@section('current_page_link', route('items.softDelete'))
...
@section('content')
    ...
    <section class="content">
        @livewire('back-end.Items.soft-delete')
        @livewire('back-end.Items.restore')
...
<script>
    ...
    {
        Livewire.on('ItemsRestoreMS', function()
        {
            toastr.success('تم تفعيل الاصناف المحذوفة بنجاح', 'رسالة تفعيل', { timeOut: 5000 });
        });

        Livewire.on('ItemsValidationMS', function()
        {
            toastr.success('هذا الصنف غير موجود', 'رسالة تحزير', { timeOut: 5000 });
        });
