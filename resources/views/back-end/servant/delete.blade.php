    ...
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="myModalLabel110">حذف المندوب </h5>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12 mb-4">
                            <div class="form-group">
                                    ...
                                    @if (isset($servant))
                                        <h3>هل تريد حذف المندوب  <span style="color: #f00;">{{$servant->name}}</span></h3>
                                    @endif
                                    @include('backEnd.error', ['property' => 'current_balance'])
