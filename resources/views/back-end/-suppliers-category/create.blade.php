    ...
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="myModalLabel110">اضافة قسم جديد  </h5>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 mb-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" placeholder="ادخل اسم القسم" wire:model="name">
                        ...
                        <div class="col-sm-6 mb-4">
                            <div class="form-group">
                                ...
                                <select wire:model="status" wire:loading.attr="disabled" class="form-control" wire:target="status">
                                    <option selected>حالة القسم</option>
