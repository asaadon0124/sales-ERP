    ...
    <div class="tab-content" id="pills-tabContent">
        ...
        <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
            @if (!empty($data) && !empty($customer))
                <div class="text-center mb-3">
                    <h5 class="text-primary">كشف حساب العميل: <strong>{{ $customer->name }}</strong></h5>
                    @if ($start_date != '')
                    ...
                    @if (!empty($data) && !empty($customer))
                        ...
                        @foreach ($data as $item)
                            <tr>
                                ...
                                <td>{{ $item->cash_amount == 0 ? $item->cash_for_account : $item->cash_amount}}</td>
        ...
        <div class="tab-pane fade" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab">
            @if (!empty($data_invoices) && !empty($customer))
                <div class="text-center mb-3">
                    <h5 class="text-primary">فواتير المشتريات من العميل: <strong>{{ $customer->name }}</strong></h5>
                    @if ($start_date != '')
                        <p class="text-muted">الفترة من <span class="text-info">{{ $start_date }}</span> إلى <span
                                class="text-info">{{ $end_date }}</span></p>
                    @else
