    ...
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="myModalLabel110">اضافة حركة جديدة  </h5>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 mb-4">
                            <div class="form-group">
                                <label>اسم نوع حركة الصنف</label>
                                <input type="text" class="form-control" placeholder="ادخل اسم نوع حركة الصنف" wire:model="name">
