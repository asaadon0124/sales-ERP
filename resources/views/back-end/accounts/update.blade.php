    ...
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="myModalLabel110">تعديل الحساب {{ $name }} </h5>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 mb-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" placeholder="ادخل اسم الحساب"
                                    wire:model="name">
                        ...
                        @if (!empty($account->transations))
                            <!-- account type id نوع الحساب -->
                            <div class="col-sm-6 mb-4">
                                <div class="form-group">
                                    <label>نوع الحساب</label>

                                    <select wire:model="account_type_id" wire:loading.attr="disabled"
                                        class="form-control" wire:target="account_type_id">
                            ...
                            <div class="col-sm-6 mb-4">
                                <div class="form-group">
                                    ...
                                    <select wire:model="is_parent" wire:loading.attr="disabled" class="form-control"
                                        wire:change="submit_is_parent($event.target.value)" wire:target="is_parent">
                            ...
                            <div class="col-sm-6 mb-4 {{ $is_parent == 0 ? '' : 'd-none' }}">
                                <div class="form-group">
                                    ...
                                    <select wire:model="parent_account_number" wire:loading.attr="disabled"
                                        class="form-control" wire:target="parent_account_number">
                                        <option selected> اختار الحساب الاب</option>
                                        @if (isset($get_parent_accounts))
                                            @foreach ($get_parent_accounts as $parent_account)
                                                <option value="{{ $parent_account->account_number }}">
                            ...
                            <div class="col-sm-6 mb-4">
                                <div class="form-group">
                                    ...
                                    <select wire:model="start_balance_status" wire:loading.attr="disabled"
                                        class="form-control" wire:target="start_balance_status" readonly>
