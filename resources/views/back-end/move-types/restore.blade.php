    ...
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="myModalLabel110">تفعيل  نوع حركة النقدية </h5>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 mb-4">
                            <div class="form-group">
                                    ...
                                    @if (isset($MoveType))
                                        <h3>هل تريد تفعيل  نوع حركة النقدية  <span style="color: rgb(70, 209, 70);">{{$MoveType->name}}</span></h3>
                                    @endif
                            </div>
                        </div>
