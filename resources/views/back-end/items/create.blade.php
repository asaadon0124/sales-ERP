<div>
    <div class="card card-info">
        <div class="card-header">
            <h3 class="card-title" style="direction: rtl;">اضافة صنف جديد</h3>
        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-4">
                        <div class="form-group" wire:ignore>
                            ...
                            <select id="unit-select" class="form-control select2" style="width: 100%;" wire:model="item_unit_id">
                                ...
                                @foreach($itemsUnitsParent as $item)
                                <option value="{{ $item->id }}">{{ $item->name }}</option>
                                @endforeach
                            </select>
                        </div>
                      ...
                      <div class="col-sm-6  mb-4 {{ $item_unit_id != '' ? '' : 'd-none' }}">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" placeholder=" ادخل سعر البيع الجملة للوحدة الاساسية  " wire:model="item_wholesale_price" step="0.01">
                    ...
                    <div class="col-sm-6  mb-4 {{ $item_unit_id != '' ? '' : 'd-none' }}">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" placeholder=" ادخل سعر البيع نصف جملة للوحدة الاساسية  " wire:model="item_Half_wholesale_price" step="0.01">
                     ...
                     <div class="col-sm-6  mb-4 {{ $item_unit_id != '' ? '' : 'd-none' }}">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" placeholder=" ادخل سعر البيع التجزئة للوحدة الاساسية  " wire:model="item_retail_price" step="0.01">
                      ...
                      <div class="col-sm-6  mb-4 {{ $item_unit_id != '' ? '' : 'd-none' }}">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" placeholder=" ادخل سعر التكلفة للوحدة الاساسية  " wire:model="item_cost_price" step="0.01">
                    ...
                    <div class="col-md-6 mb-4 {{ $retail_unit == 1 ? '' : 'd-none' }}">
                        <div class="form-group">
                            ...
                            <select class="form-control" wire:model="sub_item_unit_id">
                                ...
                                @foreach($itemsUnitsChild as $item)
                                <option value="{{ $item->id }}">{{ $item->name }}</option>
                                @endforeach
                            </select>
                    ...
                    <div class="col-sm-6  mb-4 {{ $retail_unit == 1 ? '' : 'd-none' }}">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" placeholder="ادخل عدد الوحدات الفرعية للوحة الاساسية " wire:model="qty_sub_item_unit" step="0.01">
                      ...
                      <div class="col-sm-6  mb-4 {{ $retail_unit == 1 ? '' : 'd-none' }}">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" placeholder=" ادخل سعر البيع الجملة للوحدة الفرعية  " wire:model="sub_item_wholesale_price" step="0.01">
                    ...
                    <div class="col-sm-6  mb-4 {{ $retail_unit == 1 ? '' : 'd-none' }}">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" placeholder=" ادخل سعر البيع نصف جملة للوحدة الفرعية  " wire:model="sub_item_Half_wholesale_price" step="0.01">
                     ...
                     <div class="col-sm-6  mb-4 {{ $retail_unit == 1 ? '' : 'd-none' }}">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" placeholder=" ادخل سعر البيع التجزئة للوحدة الفرعية  " wire:model="sub_item_retail_price" step="0.01">
                      ...
                      <div class="col-sm-6  mb-4 {{ $retail_unit == 1 ? '' : 'd-none' }}">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" placeholder=" ادخل سعر التكلفة للوحدة الفرعية  " wire:model="sub_item_cost_price" step="0.01">
