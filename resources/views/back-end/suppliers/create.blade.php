                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 mb-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" placeholder="ادخل اسم المورد"
                                    wire:model="name">
                        ...
                        <div class="col-sm-6 mb-4">
                            <div class="form-group">
                                ...
                                <select wire:model="supplier_Category_id" wire:loading.attr="disabled"
                                    ...
                                    @if (isset($suppliersCategory))
                                        @foreach ($suppliersCategory as $category)
                        ...
                        <div class="col-sm-6 mb-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" placeholder="ادخل عنوان المورد"
                                    wire:model="address">
                        ...
                        <div class="col-sm-6 mb-4">
                            <div class="form-group">
                                ...
                                <select wire:model="status" wire:loading.attr="disabled" class="form-control"
                                    wire:target="status">
                                    <option selected>حالة المورد</option>
