    ...
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="myModalLabel110">حذف ايصال التحصيل </h5>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 mb-4">
                            <div class="form-group">
                                    ...
                                    @if (isset($treansaction))
                                        <h3>هل تريد حذف ايصال التحصيل  <span style="color: #f00;">{{$treansaction->auto_serial}}</span></h3>
                                    @endif
                            </div>
                        </div>
