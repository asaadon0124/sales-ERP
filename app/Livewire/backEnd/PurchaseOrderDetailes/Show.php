...
class Show extends Component
{
    ...
    protected $listeners = ['purchaseOrderDetailesShow'];


    public function purchaseOrderDetailesShow($id)
    {
    ...
    public function getOrderTypeLabel()
    {
        ...
        {
            return 'مرتجعات في نفس الفاتورة';
        }
    }
    ...
    public function render()
    {
        ...
        return view('back-end.purchase-order-detailes.show',
        [
