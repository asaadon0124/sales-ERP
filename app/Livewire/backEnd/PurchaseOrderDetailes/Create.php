    ...
    public function submit()
    {
        ...
        try
        {
            ...
            if ($this->check_itemUnit_type->is_master == 'master')   //   لو الوحدة الي مختارة اساسية
            {
                ...
                $new_master_cost_price                                      = number_format($master_price_Service->calculate($this->item_code,$this->item_units_id), 2, '.', '');
                $new_sub_master_cost_price                                  = number_format($master_price_Service->calculate_sub_cost($new_master_cost_price,$this->item_selected_detailes->qty_sub_item_unit), 2, '.', '');
            ...
            }else           //  لو الوحدة المختارة فرعية
            {
                ...
                $new_sub_master_cost_price                                  = number_format($sub_master_price_Service->calculate_sub_cost($this->item_code,$this->item_units_id), 2, '.', '');
                $new_master_cost_price                                      = number_format($sub_master_price_Service->calculate($new_sub_master_cost_price,$this->item_selected_detailes->qty_sub_item_unit), 2, '.', '');
